...
namespace VisualWebGuiInvoice.BusinessObjects
{
    public class ProductController : Controller, INotifyPropertyChanged
    {
        ...
        { 
            get { 
              return _productsEntity.Id.Value;
            }
            set {
        ...
        public long TenantId
        {
            get
            {
                return _productsEntity.TenantId.Value;
            }
            set
            {
        ...
        public bool IsActivo
        {
            get
            {
                return _productsEntity.IsActivo.Value;
            }
            set
            {
        ...
        public DateTime FechaCreado
        {
            get
            {
                return _productsEntity.FechaCreado.Value;
            }
            set
            {
        ...
        public DateTime FechaModificado
        {
            get
            {
                return _productsEntity.FechaModificado.Value;
            }
            set
            {
